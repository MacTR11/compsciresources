...
(a) Calculate the maximum number of memory locations that can be addressed. **[1]** *(AO2)*
...
**9.** State what is meant by **pipelining** in a processor. **[1]**
...
**4. [2]**
- (a) **[1]** — 2²⁰ = **1,048,576 locations**. *(Accept "1M / 1048576".)*
...
**9. [1]** — Pipelining = while one instruction is being **executed**, the next is being **decoded** and a third **fetched** — the stages of the FDE cycle **overlap** for consecutive instructions, keeping all parts of the processor busy / increasing throughput.
