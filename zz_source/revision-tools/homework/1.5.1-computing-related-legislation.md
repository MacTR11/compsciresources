...
**6. [2]** 1 mark: **Copyright, Designs & Patents Act 1988** — using other people's photographs without a licence/permission infringes the rights-holders' copyright. 1 mark: **Data Protection Act 2018** — keeping users' names and emails for ten years "just in case" breaches the principle that personal data must be kept **no longer than necessary** (and/or must be limited to what is necessary). Must link each action to the correct law.
