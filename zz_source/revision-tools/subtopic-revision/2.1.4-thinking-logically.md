...
- A **decision point** is any place where execution can take different routes: `if`/`else`, `switch`/`case`, and loop tests (`while`/`for`/`do...until`).
...
| Selection | Choosing between branches using `if`/`switch...case` |
